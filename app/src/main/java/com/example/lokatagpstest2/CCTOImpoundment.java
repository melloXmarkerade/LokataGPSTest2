...
import com.example.lokatagpstest2.databinding.ActivityCctoimpoundmentBinding;
import com.google.android.gms.tasks.OnSuccessListener;
import com.google.android.gms.tasks.Task;

public class CCTOImpoundment extends FragmentActivity implements OnMapReadyCallback {
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if(location !=null){
                    ...
                    mapFragment.getMapAsync(CCTOImpoundment.this);
                }
            }
        });
