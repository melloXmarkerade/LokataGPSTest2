...
public class LapuLapuLocation extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lapu_lapu_location);
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if(location !=null){
                    ...
                    mapFragment.getMapAsync(LapuLapuLocation.this);
                }
            }
        });
