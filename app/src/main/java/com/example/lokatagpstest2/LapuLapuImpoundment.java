...
import com.example.lokatagpstest2.databinding.ActivityLapuLapuImpoundmentBinding;
import com.google.android.gms.tasks.OnSuccessListener;
import com.google.android.gms.tasks.Task;

public class LapuLapuImpoundment extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(LapuLapuImpoundmentArea).title("Lapu-Lapu Impoundment Area"));
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if(location !=null){
                    ...
                    mapFragment.getMapAsync(LapuLapuImpoundment.this);
                }
            }
        });
